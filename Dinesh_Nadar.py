...
class Major:
    ...
    def remaining_required(self, courses):
        completed_course = {course for course, grade in courses.items() if grade in {'A', 'A-', 'B', 'B-', 'C', 'C-'}}
...
class Repository:
    ...
    def student_pretty_table(self):
        ...
        p = PrettyTable(field_names=["CWID", "NAME", "MAJOR", "Completed COURSES", "Remaining Required", "Reamining Elective"])
